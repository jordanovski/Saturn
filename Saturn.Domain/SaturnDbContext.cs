namespace Saturn.Domain
{
    ...
    public partial class SaturnDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DrivingCategory>()
                .HasMany(e => e.PriceList)
                .WithRequired(e => e.DrivingCategory)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<DrivingCategory>()
                .HasMany(e => e.ReqDocDrivingCategory)
                .WithRequired(e => e.DrivingCategory)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<ErrorType>()
                .HasMany(e => e.ExamRegistrationError)
                .WithRequired(e => e.ErrorType)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<ExamCenters>()
                .Property(e => e.TaxNumber)
                .IsFixedLength();

            modelBuilder.Entity<ExamCenters>()
                .HasMany(e => e.Examination)
                .WithRequired(e => e.ExamCenters)
                .HasForeignKey(e => e.ExamCenterId)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<Examination>()
                .HasMany(e => e.ExamRegistration)
                .WithOptional(e => e.Examination)
                .HasForeignKey(e => e.ExamTypeId);

            modelBuilder.Entity<Examiner>()
                .HasMany(e => e.Examination)
                .WithOptional(e => e.Examiner)
                .HasForeignKey(e => e.PresidentId);

            modelBuilder.Entity<Examiner>()
                .HasMany(e => e.Examination1)
                .WithOptional(e => e.Examiner1)
                .HasForeignKey(e => e.ExaminerId);

            modelBuilder.Entity<Examiner>()
                .HasMany(e => e.Examination2)
                .WithOptional(e => e.Examiner2)
                .HasForeignKey(e => e.MemberId);

            modelBuilder.Entity<ExamLanguage>()
                .HasMany(e => e.ExamRegistration)
                .WithOptional(e => e.ExamLanguage)
                .HasForeignKey(e => e.LanguageId);

            modelBuilder.Entity<ExamRegistration>()
                .HasMany(e => e.ExamRegistrationError)
                .WithRequired(e => e.ExamRegistration)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<ExamRegistration>()
                .HasMany(e => e.Rescheduling)
                .WithRequired(e => e.ExamRegistration)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<ExamRegistrationStatus>()
                .HasMany(e => e.ExamRegistration)
                .WithOptional(e => e.ExamRegistrationStatus)
            ...
            modelBuilder.Entity<Instructor>()
                ...
                .HasForeignKey(e => e.InstructorPracticeId);

            modelBuilder.Entity<Instructor>()
                .HasMany(e => e.Registration1)
                .WithOptional(e => e.Instructor1)
                .HasForeignKey(e => e.InstructorTheoryId);

            modelBuilder.Entity<RegistrationStatus>()
                .HasMany(e => e.Registration)
                .WithOptional(e => e.RegistrationStatus)
                .HasForeignKey(e => e.StatusId);

            modelBuilder.Entity<Report>()
                .Property(e => e.TestNumber)
                .IsFixedLength();
            ...
            modelBuilder.Entity<RequiredDocument>()
                .HasMany(e => e.ReqDocCandidate)
                .WithRequired(e => e.RequiredDocument)
                .HasForeignKey(e => e.ReqDocumentId)
                .WillCascadeOnDelete(false);
